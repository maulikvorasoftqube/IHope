...
+ (UIImage *)generateThumb_imageFromMovie:(NSURL *)movieURL;
...
+(void)apicallforuploadimage:(NSString *)apiName file_type:(NSString*)msg_type img_param:(NSString *)img_param image:(UIImage *)selectedimage videoNSDATA:(NSData*)videodata parms:(NSMutableDictionary *)parms block:(void (^)(NSMutableDictionary *,NSError *))block;
